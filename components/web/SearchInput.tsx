...
export default function SearchInput() {
    ...
    const results = useQuery(
        api.places.searchPlaces, term.length >= 2 ?
        { limit: 5, term: term } : "skip"
    );
    ...
    return (
        <div className="relative w-full max-w-sm z-10">
            ...
            {open && term.length >= 2 && (
                <div className="absolute top-full mt-2 rounded-md border bg-popover text-popover-foreground shadow-md
